...
namespace cs4rsa_core.Views
{
    public partial class ClassGroupSession : UserControl
    {
        ...
        //    Dictionary<CheckBox, DayOfWeek> checkedDates = new()
        //    {
        ...
        //    Dictionary<CheckBox, SubjectCrawlService1.DataTypes.Enums.Session> checkSessions = new()
        //    {
        ...
        //    Dictionary<CheckBox, Place> checkboxAndPlace = new()
        //    {
