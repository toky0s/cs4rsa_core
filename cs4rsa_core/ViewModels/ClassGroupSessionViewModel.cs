...
namespace cs4rsa_core.ViewModels
{
        ...
        IMessageHandler<DeleteSubjectMessage>
    {
        ...
        private void LoadFilter(ObservableCollection<ClassGroupModel> classGroupModels)
        {
            ...
            {
                IEnumerable<DayOfWeek> daysOfClassGroupModel = item.Schedule.GetSchoolDays();
                foreach (DayOfWeek dayOfWeek in daysOfClassGroupModel)
                {
                ...
                foreach (Session session in item.Schedule.GetSessions())
                {
                ...
                foreach (Place place in item.ClassGroup.GetPlaces())
                {
