...
namespace cs4rsa_test.Crawler
{
    ...
    class TestStudentProgramCrawler
    {
        ...
        private FakeSubjectSaver subjectSaver = new FakeSubjectSaver();
        private PreParGetter PreParGetter = new PreParGetter();
        [Test]
            public void GetTrTags()
        {
            StudentProgramCrawler studentProgramCrawler = new StudentProgramCrawler(InfoForTest.sessionId, url, subjectSaver, PreParGetter);
