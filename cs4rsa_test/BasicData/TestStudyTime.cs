...
namespace cs4rsa_test.BasicData
{
    ...
    class TestStudyTime
    {
        ...
        public void TestGetStudyTimeIntersect1()
        {
            ...
            Assert.AreEqual("07:00",studyTimeIntersect.StartString);
            Assert.AreEqual("09:00",studyTimeIntersect.EndString);
        }
        ...
        public void TestGetStudyTimeIntersect2()
        {
            ...
            Assert.AreEqual("07:00", studyTimeIntersect.StartString);
            Assert.AreEqual("10:15", studyTimeIntersect.EndString);
        }
